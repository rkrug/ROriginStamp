...
test_that(
  ...
  {
    expect_error( object = store_hash(hash = "53618057a7dd4063c0ed48b6dba2608e467", information = list(name = "RMK", comments = c("comment1", "comment2"))) )
  }
)
...
test_that(
  ...
  {
    expect_known_output( object = store_hash(hash = "53618057a7dd4063c0ed48b6dba2608e46740558"), file = file.path(system.file(package = "ROriginStamp", "testdata"), "store_hash.rds") )
  }
)
